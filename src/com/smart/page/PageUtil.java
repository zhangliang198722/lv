...
import com.smart.util.KeySynchronizer;
...
public class PageUtil {
     ...
     * @return
     */
    public static <E> Page<E> getPage(int totalCount, int start, List<E> items, int pageSize) {
        IPageContext<E> pageContext = new QuickPageContext<E>(totalCount, pageSize, items);
        return pageContext.getPage(start);
    }
