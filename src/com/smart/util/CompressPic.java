...
public class CompressPic {
	...
	private File	inFile			= null; // 文件对象
	private File	outFile			= null; // 文件对象
	...
	public boolean compressPic(File f, String outputDir, String outputFileName) {
		// 输出图路径
		this.outputDir = outputDir;
		// 输出图文件名
		this.outputFileName = outputFileName;
	...
	public boolean compressPic(File inf, File outf) {
		this.inFile = inf;
		this.outFile = outf;
		return compressPic();
	}
	...
	public boolean compressPic(File inf, String outputDir, String outputFileName, int width, int height, boolean gp) {
		// 输出图路径
		this.outputDir = outputDir;
		// 输出图文件名
		this.outputFileName = outputFileName;
	...
	public boolean compressPic(File inf, File outf, int width, int height, boolean gp) {
		// 设置图片长宽
		setWidthAndHeight(width, height);
		// 是否是等比缩放 标记
		this.proportion = gp;
